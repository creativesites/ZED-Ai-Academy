    ...
    <Layout headerStyle={2} footerStyle={1} breadcrumbTitle="Contact Us">
      <section className="contact-page py-24">
        <div className="container">
          <div className="row">
            {/* Left — Intro */}
            <div className="col-xl-6 lg:mb-20 p-10">
              <div className="contact-page__top-content pr-12">
                <div className="sec-title mb-10">
                  ...
                  <h2 className="text-5xl px-6 py-2 font-extrabold text-[#062e39] tracking-tight leading-[1.1] mb-6">
                    Have a question? <br />
                    We&apos;re here to <span className="text-[#fd5523]">help you.</span>
                  </h2>
                  <p className="text-xl px-6 text-slate-500 leading-relaxed max-w-lg">
